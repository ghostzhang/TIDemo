...
function doSetBox(e){
    ...
    for (var i = 0; i < config.length; i++) {
        ...
        if (t != null) {
            ...
            switch (t[2]) {
                case 'text':
                    html += '<label for="' + t[2] + num + '">' + t[1] + (t[3] != undefined ? '<span class="right">' + t[3] + '</span>' : '') + '：</label>';
                ...
                case 'link':
                    ...
                    html += '<fieldset><legend>' + t[1] + '</legend>' + (t[3] != undefined ? '<p>' + t[3] + '</p>' : '');
...
var appMain = function(){
    ...
    function loadApp(){
        ...
        $("#app-title").text(gAppName + " v" + gAppVersion + " | 2012 by CSSForest.org GhostZhang");
